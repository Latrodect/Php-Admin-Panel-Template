              ...
              <form class="form-horizontal" action="islem.php" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="smtpuser"class="form-control"value="<?php echo $mail_cek['smtpuser']; ?>" id="inputPassword3" placeholder="Exp: Old Thief Studio">
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="smtphost"class="form-control"value="<?php echo $mail_cek['smtphost']; ?>" id="inputPassword3" placeholder="Exp: Old Thief Studio">
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="smtpport"class="form-control"value="<?php echo $mail_cek['smtpport']; ?>" id="inputPassword3" placeholder="Exp: Old Thief Studio">
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="smptpass"class="form-control"value="<?php echo $mail_cek['smptpass']; ?>" id="inputPassword3" placeholder="Exp: Old Thief Studio">
                    </div>
