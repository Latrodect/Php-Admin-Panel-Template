              ...
              <form class="form-horizontal" action="islem.php" method="POST">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="title" class="form-control" value="<?php echo $ayar_cek['site_adi']; ?>" id="inputEmail3"  placeholder="Exp: Old Thief Studio">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Site İsmi</label>
                    <div class="col-sm-10">
                      <input type="text" name="site_adi"class="form-control"value="<?php echo $ayar_cek['site_adi']; ?>" id="inputPassword3" placeholder="Exp: Old Thief Studio">
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="site_aciklama" value="<?php echo $ayar_cek['site_aciklama']; ?>" class="form-control" id="inputPassword3" placeholder="Exp: Desktop & Mobile Game Development">
                    </div>
                ...
                <form action="islem.php" method="POST">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Adres</label>
                        <input class="form-control" name = "site_adres" value="<?php echo $ayar_cek['site_adres']; ?>" rows="3" placeholder="Exp: OldThiefStudioAtatürk Mah. 895 Sokak 16/1 No:15İzmir / Bornova ..."></input>
                      </div>
                    </div>
                    ...
                    <label class="col-form-label" ><i class=""></i> Resmi Mail</label>
                      ...
                      <div class="form-group">
                        <div class="form-check">
                          ...
                          <label class="form-check-label"  >info@oldthiefstudio.com</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="radio1" checked>
                          <label class="form-check-label">mail@oldthiefsutdio.com</label>
                        </div>
                        <div class="form-check">
